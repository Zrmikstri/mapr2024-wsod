...
\author{\IEEEauthorblockN{1\textsuperscript{st} Vinh Phu Tran}
    \IEEEauthorblockA{
        % \textit{dept. name of organization (of Aff.)} \\
        \textit{University of Information Technology, VNU}\\
        % \textit{Vietnam National University}\\
        Ho Chi Minh City, Vietnam\\
        20522161@gm.uit.edu.vn
    }
    \and
    \IEEEauthorblockN{2\textsuperscript{nd} Tuan Tran Anh Dao}
    \IEEEauthorblockA{
        % \textit{dept. name of organization (of Aff.)} \\
        \textit{University of Information Technology, VNU}\\
        % \textit{Vietnam National University}\\
    ...
    \and
    \IEEEauthorblockN{3\textsuperscript{rd} Tien Dung Mai}
    \IEEEauthorblockA{
        % \textit{dept. name of organization (of Aff.)} \\
        \textit{University of Information Technology, VNU}\\
        % \textit{Vietnam National University}\\
    ...
    \and
    \IEEEauthorblockN{4\textsuperscript{th} Thanh Duc Ngo}
    \IEEEauthorblockA{
        % \textit{dept. name of organization (of Aff.)} \\
        \textit{University of Information Technology, VNU}\\
        % \textit{Vietnam National University}\\
...
\begin{table}[t]
    \centering
    \caption{performance difference: otsu thresholding vs global thresholding on voc 2007 (val)}
...
\begin{table}[t]
    \centering
    \caption{performance difference: otsu thresholding vs global thresholding on voc 2007 (test)}
...
\begin{table}[t]
    \centering
    \caption{performance difference: otsu thresholding vs global thresholding on voc 2012 (val)}
